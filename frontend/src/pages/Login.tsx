...
export default function Login() {
  ...
  return (
    <section className="auth-shell relative overflow-hidden py-10 md:py-14 lg:py-16">
      <div
        className="auth-orb top-8 -left-24 h-72 w-72 bg-brand-400/30"
        style={{ animationDelay: "0s" }}
        aria-hidden
      />
      <div
        className="auth-orb right-0 bottom-0 h-80 w-80 bg-indigo-400/20"
        style={{ animationDelay: "-3s" }}
        aria-hidden
      />
      <div
        className="auth-orb top-1/3 left-1/2 h-56 w-56 -translate-x-1/2 bg-sky-300/25"
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
        <div className="auth-card-enter overflow-hidden rounded-[1.75rem] border border-white/60 bg-white/70 shadow-[0_8px_40px_-12px_rgb(37_99_235/0.25)] backdrop-blur-xl md:grid md:grid-cols-[1.05fr_1fr]">
          ...
          <div className="relative overflow-hidden bg-linear-to-br from-brand-700 via-brand-600 to-indigo-700 px-8 py-10 text-white md:px-10 md:py-12">
            ...
            />
            <div
              className="pointer-events-none absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-brand-400/20"
              aria-hidden
            />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {mode === "signup" ? (
                <div className="auth-card-enter" style={{ animationDelay: "0.05s" }}>
                  ...
                  <div className="relative">
                    <FieldIcon>
                      <svg className="h-[1.125rem] w-[1.125rem]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
